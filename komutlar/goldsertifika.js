...
Jimp.read(user.avatarURL, (err, image) => {
    ...
    Jimp.read("https://cdn.discordapp.com/attachments/687363038394712090/746149779620495440/golduye.png", (err, avatar) => {
        avatar.resize(315, 320)
        image.composite(avatar, 1, 0).write(`./img/goldsertifika/${client.user.id}-${user.id}.png`);
        setTimeout(function() {
            message.channel.send(new Discord.Attachment(`./img/goldsertifika/${client.user.id}-${user.id}.png`));
        }, 1000);
    });
